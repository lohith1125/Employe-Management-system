...
btnAdd = Button(btn_frame, command=lambda: add_employee(), text="Add Details", width=15, font=("Calibri", 16, "bold"), fg="white", bg="#16a085", bd=0)
btnAdd.grid(row=0, column=0)

btnEdit = Button(btn_frame, command=lambda: update_employee(), text="Update Details", width=15, font=("Calibri", 16, "bold"), fg="white", bg="#2980b9", bd=0)
btnEdit.grid(row=0, column=1, padx=10)

btnDelete = Button(btn_frame, command=lambda: delete_employee(), text="Delete Details", width=15, font=("Calibri", 16, "bold"), fg="white", bg="#c0392b", bd=0)
btnDelete.grid(row=0, column=2, padx=10)

btnClear = Button(btn_frame, command=lambda: clear_all(), text="Clear Details", width=15, font=("Calibri", 16, "bold"), fg="white", bg="#f39c12", bd=0)
...
tv.bind("<ButtonRelease-1>", lambda event: get_data(event))
